...
const serviceContents = [
  {
    ...
    title: 'Webサイト制作',
    text: `新規サイトはもちろん、サイトリニューアルやランディングページ制作も承っております。<br>
  ...
  },
  {
    ...
    title: 'Webサイト運用',
    text: `サイトの更新作業や独自のアクセス解析に基づいたサイト改善のご提案が可能です。<br>
  ...
  },
  {
    ...
    title: 'アプリ開発',
    text: `スマートフォンアプリ開発の他、Vue.jsやReactによるWebアプリの開発が可能です。 開発力のみなら
